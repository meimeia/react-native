...
export default class extends React.Component {
    ...
    render() {
        return <View style={styles.container}>
            {/*顶部组件*/}
            <TopHeader title='登录' navigation={this.props.navigation} showShare={false} rightBtn={<View style={{flex:1}}></View>}/>
            {/*Logo*/}
            <View>
                <Image
                    source={{ uri: require('../static/img/logo_new') }}
            ...
            <View style={{ position: 'absolute', bottom: px(80) }}>
                <TouchableOpacity style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}
                    ...
                    <Image source={{ uri: require('../static/img/icon-wechat') }} style={{ width: px(38), height: px(38), marginRight: px(13) }} />
