                    ...
                    ? <View style={styles.operatingBtn}>
                        <TouchableOpacity activeOpacity={0.8}
                            ...
                            {this.props.editorArr.indexOf(this.props.items.id) < 0 ?
                                <Image source={{ uri: require('../../../static/img/tab-shopping-cart-select') }}
                                       resizeMode='cover'
                                       style={{ width: px(34), height: px(34) }} />
                                : <Image source={{ uri: require('../../../static/img/tab-shopping-cart-selected') }}
                                         resizeMode='cover'
                                         style={{ width: px(34), height: px(34) }} />
                            }
                        </TouchableOpacity>
    ...
    render() {
        ...
        return <View style={styles.footer}>
            <View style={styles.operatingBtn}>
                <TouchableOpacity activeOpacity={0.8}
                                  style={styles.operatingBtnBox}
                                  onPress={()=>CartList.selectAll()}>
                    {CartList.isSelectAll.get()
                        ? <Image source={{ uri: require('../../../static/img/tab-shopping-cart-selected') }}
                                 resizeMode='cover'
                                 style={{ width: px(34), height: px(34) }} />
                        : <Image source={{ uri: require('../../../static/img/tab-shopping-cart-select') }}
    ...
    render() {
        return <View style={{ flex: 1, backgroundColor: '#f5f3f6', paddingBottom: px(100) }}>
            ...
            <Header
                ...
                rightBtn={this.state.editStatus ?<View style={{flex:1,alignItems:"flex-end"}}>
                        <Text allowFontScaling={false}
                              onPress={() => this.done()}
